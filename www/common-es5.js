...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesFavouriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var STORAGE_KEY2 = 'favouriteCharacters';
    var STORAGE_KEY3 = 'favouriteQuotes';
    ...
    var FavouriteService = /*#__PURE__*/function () {
      ...
      _createClass(FavouriteService, [{
        ...
        key: "isLiked",
        value: function isLiked(charactherId) {
        ...
        value: function favouriteCharacter(charactherId) {
          var _this3 = this;
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              return _this3.storage.set(STORAGE_KEY2, [charactherId]);
            }
          });
        }
      }, {
        key: "unfavouriteCharacter",
        value: function unfavouriteCharacter(charactherId) {
          var _this4 = this;
        ...
        key: "isFavourited",
        value: function isFavourited(quoteId) {
        ...
        value: function favouriteQuote(quoteId) {
          ...
          return this.getAllFavouriteQuotes().then(function (result) {
            if (result) {
              result.push(quoteId);
              return _this5.storage.set(STORAGE_KEY3, result);
            } else {
              return _this5.storage.set(STORAGE_KEY3, [quoteId]);
            }
          });
        }
      }, {
        ...
        value: function unfavouriteQuote(quoteId) {
          ...
          return this.getAllFavouriteQuotes().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this6.storage.set(STORAGE_KEY3, result);
            }
          });
        }
      }]);
