...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["deaths-deaths-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppPagesDeathsDeathsPageHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<ion-header>\n\t<ion-toolbar color=\"dark\">\n\t\t<ion-title>Death Count</ion-title>\n\t</ion-toolbar>\n</ion-header>\n\n<ion-content>\n\n\t<ion-card *ngFor=\"let death of (deaths | async)\">\n\n\t\t\n\t\t<ion-item lines=\"none\" class=\"movie-info\">\n\t\t\t<ion-icon color=\"warning\" name=\"skull-outline\" slot=\"start\"></ion-icon>\n\t\t\tDeath-Count : {{ death.deathCount }}\n\t\t</ion-item>\n\n        <ion-item lines=\"none\" padding=\"\">\n \n    <img src=\"https://i.pinimg.com/originals/2e/8f/4f/2e8f4f270549afe5be99e93d29b4b660.jpg\">\n \n\t\t</ion-item>\n\n\n\n\n\t</ion-card>\n\n</ion-content>";
    /***/
  },
  ...
  function srcAppPagesDeathsDeathsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DeathsPage = /*#__PURE__*/function () {
      ...
      _createClass(DeathsPage, [{
        ...
        value: function openDetails(death) {
          ...
          this.router.navigateByUrl("/tabs/death/".concat(deathId));
        }
      }]);
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])], DeathsPage);
    /***/
  }
}]);
